...
### Data
You'll need to copy-paste this into a .json file in order for the app to have the data it needs to run properly.
```{
  "users": [
    {
      "email": "lukeslater101@gmail.com",
      "firstName": "Luke",
      "lastName": "Slater",
      "id": 1
    }
  ...
  "classes": [
    ...
    },
    {
      ...
      "hpLevelOne": 8,
      "hitDieSides": 8,
      "icon": "./images/monk.svg",
      "desc": "A master of martial arts, who pursues physical and spiritual perfection."
    },
    {
      "id": 7,
      "className": "Paladin",
      ...
      "hpLevelOne": 10,
      "hitDieSides": 10,
      "icon": "./images/paladin.svg",
      "desc": "A holy warrior bound to a sacred oath, who swears to uphold justice and righteousness."
    },
    {
      "id": 8,
      "className": "Rogue",
